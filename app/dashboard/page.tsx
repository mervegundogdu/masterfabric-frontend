...
export default function Dashboard() {
  ...
  const loadModel = async () => {
    try {
      setStatusText("Fetching Gemma 2B Model...");
      const clientEngine = await CreateMLCEngine("gemma-2b-it-q4f16_1-MLC", {
      ...
      setStatusText("Gemma 2B ready via local hardware acceleration (WebGPU)!");
    } catch (error) {
      console.error(error);
            ...
            <div className="bg-[#111622] p-5 rounded-2xl border border-gray-800 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative overflow-hidden">
              <div className="flex-1 w-full">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs text-gray-400 font-medium">gemma-2b-it-q4f16_1-MLC</span>
                </div>
